...
| File | Description |
|:---|:---|
| `WPT_PWM_系统工作流.vsdx` | Visio 4-page system workflow diagram (A4 landscape, Chinese labels) |
| `draw_visio_v4.py` | Python COM automation script to generate the .vsdx (requires `pywin32` + Microsoft Visio) |
...
```bash
python draw_visio_v4.py
```

**Requirements**: Microsoft Visio installed, `pywin32` Python package.

**Output**: `WPT_PWM_系统工作流.vsdx` (overwritten each run).
