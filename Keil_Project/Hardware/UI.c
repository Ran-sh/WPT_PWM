 ...
 * @note    V2.0.0: 拆分为 UI_UpdateLEDs / UI_TryConnectWiFi / UI_HandleKeys
...
{
    (void)on_off;  /* V2.0.0: 由 Inverter_SoftStart_GetState 推导 */
}
...
{
    (void)on_off;  /* V2.0.0: 由 App_Net_IsConnected() 权威持有 */
}
