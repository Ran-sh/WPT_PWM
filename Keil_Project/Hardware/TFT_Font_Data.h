...
/* ==============================================================
 *  2. 16乘16中文启动字库：无、线、充、电
 *     字节内最低位对应最先绘制的像素
 * ============================================================== */

#define TFT_CN_FONT_CHAR_COUNT  4

static const char CN_INDEX[] = /* 四字UTF-8编码索引 */
