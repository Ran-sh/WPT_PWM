 ...
 * @brief   SPLASH 片内 ROM 字库 (仅开机动画用, V4.3.2)
 * @note    仅被 Tft_Driver.c 包含, static const 数据 ~1.7KB ROM
 *          - 8x16 ASCII 95字符 (TFT_FONT_8X16) — SPLASH "V4.3.2" "WPT"
 *          - 16x16 中文 4汉字 (CN_INDEX + CN_FONT_16X16) — SPLASH 无/线/充/电
 *          - 图标已全部迁移至 W25Q128 Flash (V2 Font_Header icon_table_offset)
 ******************************************************************************
 */
...
/* ═══════════════════════════════════════════════════════════════
 *  2. 16x16 中文 SPLASH 字库 (4 字: 无/线/充/电, 宋体, LSB-first)
 * ═══════════════════════════════════════════════════════════════ */

#define TFT_CN_FONT_CHAR_COUNT  4

static const char CN_INDEX[] = /* UTF-8 索引 */
    "\xe6\x97\xa0" /* 0 无 */ "\xe7\xba\xbf" /* 1 线 */
    "\xe5\x85\x85" /* 2 充 */ "\xe7\x94\xb5" /* 3 电 */
    ;

static const uint8_t CN_FONT_16X16[TFT_CN_FONT_CHAR_COUNT][32] = {
    /* 0 无 */ {0x00,0x00,0xFC,0x0F,0x40,0x00,0x40,0x00,0x40,0x00,0x40,0x00,0xFE,0x3F,0x20,0x01, 0x20,0x01,0x20,0x01,0x10,0x01,0x10,0x01,0x08,0x21,0x04,0x21,0x02,0x3E,0x01,0x00},
    /* 1 线 */ {0x08,0x0A,0x08,0x12,0x04,0x02,0x24,0x3A,0xA2,0x07,0x1F,0x02,0x08,0x7A,0xC4,0x07, 0x02,0x22,0x3F,0x12,0x02,0x0C,0x00,0x44,0x38,0x4A,0x07,0x51,0xC2,0x60,0x00,0x40},
    /* 2 充 */ {0x40,0x00,0x80,0x00,0xFF,0x7F,0x20,0x00,0x20,0x00,0x10,0x04,0x08,0x08,0xFC,0x1F, 0x20,0x12,0x20,0x02,0x20,0x02,0x20,0x02,0x10,0x22,0x10,0x22,0x08,0x22,0x06,0x3C},
    /* 3 电 */ {0x80,0x00,0x80,0x00,0x80,0x00,0xFC,0x1F,0x84,0x10,0x84,0x10,0x84,0x10,0xFC,0x1F, 0x84,0x10,0x84,0x10,0x84,0x10,0xFC,0x1F,0x84,0x50,0x80,0x40,0x80,0x40,0x00,0x7F},
};

/* ═══════════════════════════════════════════════════════════════
 *  3. ROM 图标 — Flash 无效时的回退 (WIFI_OFF / WIFI_REMOVE / MQTT_NO)
 * ═══════════════════════════════════════════════════════════════ */

/* ── WIFI 信号图标 (4帧: 0=圆心, 3=满格) ── */
...
/* ── 图标寄存器 (static, 仅被 Tft_Driver.c 引用) ── */
